...
# 1. Configuration
# ═════════════════════════════════════════════════════════════════════════════
# تم تعديل المسارات لتطابق مجلد البيئة الجديد والمستقر الخاص بك
...
# ═════════════════════════════════════════════════════════════════════════════
# 3. Model Loading (تم تعديل مفسر الـ TFLite ليعمل على الـ Coral Edge TPU)
# ═════════════════════════════════════════════════════════════════════════════
_yolo_session = None
_tflite_interp = None
...
def get_tflite_interpreter():
    ...
    if _tflite_interp is None:
        ...
        try:
            # نقوم بجلب محرك قطعة الكورال وتمريره إلى المفسر لتشغيل موديل الشاخصات على الهاردوير السريع
